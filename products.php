  ...
  ?>
              ...
              <li class="current">
                                <a href="services.php"><div>Profile</div></a>
														...
														<li class="current">
							                                <a href="Msg_service.php"><div>Message</div></a>
        ...
        <?php
          ...
          if($result){
            ...
            while($obj = $result->fetch_object()) {
              ...
              echo '<img src="'.$obj->itempic.'"/>';
            //  echo '<p>'.$obj->itempic.'</p>';
          ...
          //    echo '<p><strong>Units Available</strong>: '.$obj->qty.'</p>';
             ...
             if($qty >= 0){
                echo '<p><a href="ViewProduct"><input type="button" value="View Product" style="clear:both; background: #0078A0; border: none; color: #fff; font-size: 1em; padding: 10px;" /></a></p>';
